    ...
    sections: [
      {
        ...
        title: 'Фреймы и окна',
        lessons: [
          createLesson('popup-windows', 'Открытие окон и методы window', 'https://learn.javascript.ru/popup-windows', 'Окна'),
          createLesson('cross-window-communication', 'Общение между окнами', 'https://learn.javascript.ru/cross-window-communication', 'Окна'),
          createLesson('clickjacking', 'Атака типа clickjacking', 'https://learn.javascript.ru/clickjacking', 'Окна'),
        ],
      },
      {
        id: 'binary',
        ...
        lessons: [
          createLesson('arraybuffer-binary-arrays', 'ArrayBuffer, бинарные массивы', 'https://learn.javascript.ru/arraybuffer-binary-arrays', 'Binary'),
          createLesson('text-decoder', 'TextDecoder и TextEncoder', 'https://learn.javascript.ru/text-decoder', 'Binary'),
          createLesson('blob', 'Blob', 'https://learn.javascript.ru/blob', 'Binary'),
          createLesson('file', 'File и FileReader', 'https://learn.javascript.ru/file', 'Binary'),
        ],
      },
      {
        id: 'network',
        ...
        lessons: [
          ...
          createLesson('fetch-progress', 'Fetch: ход загрузки', 'https://learn.javascript.ru/fetch-progress', 'Сеть'),
          createLesson('fetch-abort', 'Fetch: прерывание запроса', 'https://learn.javascript.ru/fetch-abort', 'Сеть'),
          createLesson('fetch-crossorigin', 'Fetch: запросы на другие сайты', 'https://learn.javascript.ru/fetch-crossorigin', 'Сеть'),
          createLesson('fetch-api', 'Fetch API', 'https://learn.javascript.ru/fetch-api', 'Сеть'),
          createLesson('url', 'Объекты URL', 'https://learn.javascript.ru/url', 'Сеть'),
          createLesson('xmlhttprequest', 'XMLHttpRequest', 'https://learn.javascript.ru/xmlhttprequest', 'Сеть'),
          createLesson('resume-upload', 'Возобновляемая загрузка файлов', 'https://learn.javascript.ru/resume-upload', 'Сеть'),
          createLesson('long-polling', 'Длинные опросы', 'https://learn.javascript.ru/long-polling', 'Сеть'),
          createLesson('websocket', 'WebSocket', 'https://learn.javascript.ru/websocket', 'Сеть'),
          createLesson('server-sent-events', 'Server Sent Events', 'https://learn.javascript.ru/server-sent-events', 'Сеть'),
        ],
      },
      {
        id: 'data-storage',
        ...
        lessons: [
          createLesson('cookie', 'Куки, document.cookie', 'https://learn.javascript.ru/cookie', 'Хранение'),
      ...
      },
      {
        ...
        title: 'Анимация',
        lessons: [
          createLesson('bezier-curve', 'Кривые Безье', 'https://learn.javascript.ru/bezier-curve', 'Анимация'),
          createLesson('css-animations', 'CSS-анимации', 'https://learn.javascript.ru/css-animations', 'Анимация'),
          createLesson('js-animation', 'JavaScript-анимации', 'https://learn.javascript.ru/js-animation', 'Анимация'),
        ],
      },
      {
        id: 'web-components',
        ...
        lessons: [
          createLesson('webcomponents-intro', 'С орбитальной высоты', 'https://learn.javascript.ru/webcomponents-intro', 'Web Components'),
          createLesson('custom-elements', 'Пользовательские элементы (Custom Elements)', 'https://learn.javascript.ru/custom-elements', 'Web Components'),
          createLesson('shadow-dom', 'Shadow DOM', 'https://learn.javascript.ru/shadow-dom', 'Web Components'),
          createLesson('template-element', 'Элемент "template"', 'https://learn.javascript.ru/template-element', 'Web Components'),
          createLesson('slots-composition', 'Слоты теневого DOM, композиция', 'https://learn.javascript.ru/slots-composition', 'Web Components'),
          createLesson('shadow-dom-style', 'Настройка стилей теневого DOM', 'https://learn.javascript.ru/shadow-dom-style', 'Web Components'),
          createLesson('shadow-dom-events', 'Теневой DOM и события', 'https://learn.javascript.ru/shadow-dom-events', 'Web Components'),
        ],
      },
      {
        ...
        lessons: [
          createLesson('regexp-introduction', 'Введение: шаблоны и флаги', 'https://learn.javascript.ru/regexp-introduction', 'RegExp'),
          createLesson('regexp-character-classes', 'Символьные классы', 'https://learn.javascript.ru/regexp-character-classes', 'RegExp'),
          createLesson('regexp-unicode', 'Юникод: флаг "u" и класс \\p{...}', 'https://learn.javascript.ru/regexp-unicode', 'RegExp'),
          createLesson('regexp-anchors', 'Якоря: начало строки ^ и конец $', 'https://learn.javascript.ru/regexp-anchors', 'RegExp'),
          createLesson('regexp-multiline-mode', 'Многострочный режим якорей ^ $, флаг "m"', 'https://learn.javascript.ru/regexp-multiline-mode', 'RegExp'),
          createLesson('regexp-boundary', 'Граница слова: \\b', 'https://learn.javascript.ru/regexp-boundary', 'RegExp'),
          createLesson('regexp-escaping', 'Экранирование, специальные символы', 'https://learn.javascript.ru/regexp-escaping', 'RegExp'),
          createLesson('regexp-character-sets-and-ranges', 'Наборы и диапазоны [...]', 'https://learn.javascript.ru/regexp-character-sets-and-ranges', 'RegExp'),
          createLesson('regexp-quantifiers', 'Квантификаторы +, *, ? и {n}', 'https://learn.javascript.ru/regexp-quantifiers', 'RegExp'),
          createLesson('regexp-greedy-and-lazy', 'Жадные и ленивые квантификаторы', 'https://learn.javascript.ru/regexp-greedy-and-lazy', 'RegExp'),
          createLesson('regexp-groups', 'Скобочные группы', 'https://learn.javascript.ru/regexp-groups', 'RegExp'),
          createLesson('regexp-backreferences', 'Обратные ссылки в шаблоне: \\N и \\k<имя>', 'https://learn.javascript.ru/regexp-backreferences', 'RegExp'),
          createLesson('regexp-alternation', 'Альтернация (или) |', 'https://learn.javascript.ru/regexp-alternation', 'RegExp'),
          createLesson('regexp-lookahead-lookbehind', 'Опережающие и ретроспективные проверки', 'https://learn.javascript.ru/regexp-lookahead-lookbehind', 'RegExp'),
          createLesson('regexp-catastrophic-backtracking', 'Катастрофический возврат', 'https://learn.javascript.ru/regexp-catastrophic-backtracking', 'RegExp'),
          createLesson('regexp-sticky', 'Поиск на заданной позиции, флаг "y"', 'https://learn.javascript.ru/regexp-sticky', 'RegExp'),
          createLesson('regexp-methods', 'Методы RegExp и String', 'https://learn.javascript.ru/regexp-methods', 'RegExp'),
        ],
      },
      {
        id: 'css-for-js',
        ...
        lessons: [
          createLesson('css-why', 'О чём пойдёт речь', 'https://learn.javascript.ru/css-why', 'CSS'),
          createLesson('css-units', 'Единицы измерения: px, em, rem и другие', 'https://learn.javascript.ru/css-units', 'CSS'),
          createLesson('display', 'Все значения свойства display', 'https://learn.javascript.ru/display', 'CSS'),
          createLesson('float', 'Свойство float', 'https://learn.javascript.ru/float', 'CSS'),
          createLesson('position', 'Свойство position', 'https://learn.javascript.ru/position', 'CSS'),
          createLesson('css-center', 'Центрирование горизонтальное и вертикальное', 'https://learn.javascript.ru/css-center', 'CSS'),
          createLesson('font-size-line-height', 'Свойства font-size и line-height', 'https://learn.javascript.ru/font-size-line-height', 'CSS'),
          createLesson('white-space', 'Свойство white-space', 'https://learn.javascript.ru/white-space', 'CSS'),
          createLesson('outline', 'Свойство outline', 'https://learn.javascript.ru/outline', 'CSS'),
          createLesson('box-sizing', 'Свойство box-sizing', 'https://learn.javascript.ru/box-sizing', 'CSS'),
          createLesson('margin', 'Свойство margin', 'https://learn.javascript.ru/margin', 'CSS'),
          createLesson('space-under-img', 'Лишнее место под IMG', 'https://learn.javascript.ru/space-under-img', 'CSS'),
          createLesson('overflow', 'Свойство overflow', 'https://learn.javascript.ru/overflow', 'CSS'),
          createLesson('height-percent', 'Особенности свойства height в %', 'https://learn.javascript.ru/height-percent', 'CSS'),
          createLesson('css-selectors', 'Знаете ли вы селекторы?', 'https://learn.javascript.ru/css-selectors', 'CSS'),
          createLesson('css-sprite', 'CSS-спрайты', 'https://learn.javascript.ru/css-sprite', 'CSS'),
          createLesson('css-format', 'Правила форматирования CSS', 'https://learn.javascript.ru/css-format', 'CSS'),
        ],
      }
    ],
  },
